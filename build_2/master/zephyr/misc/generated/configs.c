...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SAMPLE_LED_UPDATE_DELAY, 200);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_G915, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_GPIO_KBD_MATRIX_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_GPIO_LEDS_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_INPUT_KEYMAP_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_G915_NRF5340_CPUAPP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INPUT_GPIO_KBD_MATRIX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INPUT_KBD_MATRIX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INPUT_KBD_MATRIX_THREAD_STACK_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INPUT_KBD_MATRIX_THREAD_PRIORITY, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INPUT_KEYMAP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_VID, 0x2FE2);
